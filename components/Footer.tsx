  ...
  return (
    <div className="bg-[#11040E] p-8 md:p-16 w-full">
      <div className="w-full max-w-[1312px] mx-auto flex flex-col md:flex-row justify-between gap-8">
        ...
        <div className="max-w-[295px] flex flex-col gap-4">
          <p className="font-bold text-[20px] text-white">What We Do</p>
        ...
        <div className="max-w-[295px] flex flex-col gap-4">
          <p className="font-bold text-[20px] text-white">Company</p>
          <div className="flex flex-col gap-2">
            {[
              "About",
              "Jobs",
        ...
        <div className="max-w-[295px] flex flex-col gap-4">
          <p className="font-bold text-[20px] text-white">Solution</p>
          <div className="flex flex-col gap-2">
            {[
      ...
      <div className="max-w-[312px] max-h-[221px] pt-[20px] pb-[20px] gap-2">
        <div className="bg-[#FFFFFF0F] rounded-lg p-[24px] max-h-[181px] gap-[24px]">
            <div></div>
        </div>
      </div>
    </div>
